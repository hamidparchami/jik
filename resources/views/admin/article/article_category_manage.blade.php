...
@section('content')
    <div class="container main-container">
        ...
        <div class="row">
            <div class="col-md-6">
                <a class="btn btn-primary" href="/admin/article-category/create">دسته جدید</a>
            </div>
        ...
        <table id="dataTable" class="table table-striped table-bordered dataTable" cellspacing="0" width="100%">
            ...
            @foreach($categories as $category)
                <tr>
                    <td>
                        <a href="/admin/article-category/edit/id/{{ $category->id }}">ویرایش</a> |
                        <a class="delete" href="/admin/article-category/delete/id/{{ $category->id }}">حذف</a>
                    </td>
