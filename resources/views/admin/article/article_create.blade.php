            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <div class="panel panel-default">
                        <div class="panel-heading rtl">مطلب جدید</div>
                        <div class="panel-body">
                           ...
                           {{-- <div class="row form-row">
                                <div class="col-md-8">
                                    <textarea name="short_content" class="form-control rtl" rows="4">{{ old('short_content') }}</textarea>
                                </div>
                            ...
                            <div class="row form-row">
                                <div class="col-md-8">
                                    <textarea name="content" class="form-control rtl" rows="4">{{ old('content') }}</textarea>
                                </div>
                            ...
                            <div class="row form-row">
                                <div class="col-md-4"></div>
                                <div class="col-md-4"><input name="order" type="text" class="form-control" value="{{ old('order') }}"></div>
