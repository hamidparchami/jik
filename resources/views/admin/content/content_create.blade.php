                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row form-row">
                                ...
                                <div class="col-md-2">
                                    <select name="send_type" id="send_type" class="form-control rtl">
                                        <option value="pull" @if((isset($content->send_type) && $contetn->send_type == 'pull') || (old('send_type') == 'pull')) selected @endif>ترتیبی - درخواستی</option>
                                        <option value="push" disabled="disabled" @if((isset($content->send_type) && $contetn->send_type == 'push') || (old('send_type') == 'push')) selected @endif>ارسال خودکار</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row form-row" id="full_content_container" style="display: none;">
                                <div class="col-md-8">
                                    <textarea name="full_content" class="form-control rtl" rows="4">{{ old('full_content') }}</textarea>
                                </div>
                            ...
                            <div class="row form-row" id="publish_time" style="display:none;">
                                <div class="col-md-4"></div>
                                <div class="col-md-4">
                                    <input name="publish_time" type="text" class="form-control" value="{{ old('publish_time') }}">
                                </div>
                            ...
                            <div class="row form-row">
                                <div class="col-md-2">
                                    <div class="checkbox checkbox-success">
                                        <input id="checkbox" class="styled" type="checkbox" name="show_instant_view" @if((is_null(old('show_instant_view'))) || (old('show_instant_view') == 1 || old('show_instant_view') == 'on')) checked @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="checkbox checkbox-success">
                                        <input id="checkbox" class="styled" type="checkbox" name="is_active" @if(is_null(old('is_active')) || (old('is_active') == 1 || old('is_active') == 'on')) checked @endif>
                                        <label for="checkbox"></label>
                                    </div>
                                </div>
