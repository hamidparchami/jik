        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <div class="panel panel-default">
                    <div class="panel-heading rtl">ویرایش URL</div>
                    <div class="panel-body">
                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-md-4">
                                <select name="parent_id" class="form-control rtl">
                                    <option value="0" @if($url->parent_id == 0 || old('parent_id') == 0) selected @endif> ---------- </option>
                                    @foreach($parents as $parent)
                                        <option value="{{ $parent->id }}" @if($parent->id == $url->parent_id) selected @endif>{{ $parent->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row form-row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <input name="url" type="text" class="form-control" value="{{ (old('url')) ?: $url->url }}">
                            </div>
                        ...
                        <div class="row form-row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <input name="title" type="text" class="form-control rtl" value="{{ (old('title')) ?: $url->title }}">
                            </div>
                        ...
                        <div class="row form-row">
                            <div class="col-md-4"></div>
                            <div class="col-md-4">
                                <input name="order" type="text" class="form-control" value="{{ (old('order')) ?: $url->order }}">
                            </div>
