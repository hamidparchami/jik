...
<head>
  ...
  <link rel="stylesheet" href="@if(!App::environment('local')){{ secure_asset('vendor/laravel-filemanager/css/cropper.min.css') }}@else{{ asset('vendor/laravel-filemanager/css/cropper.min.css') }}@endif">
  <link rel="stylesheet" href="@if(!App::environment('local')){{ secure_asset('/vendor/laravel-filemanager/css/lfm.css') }}@else{{ asset('/vendor/laravel-filemanager/css/lfm.css') }}@endif">
...
<body>
  ...
  <script src="@if(!App::environment('local')){{ secure_asset('vendor/laravel-filemanager/js/cropper.min.js') }}@else{{ asset('vendor/laravel-filemanager/js/cropper.min.js') }}@endif"></script>
  <script src="@if(!App::environment('local')){{ secure_asset('vendor/laravel-filemanager/js/jquery.form.min.js') }}@else{{ asset('vendor/laravel-filemanager/js/jquery.form.min.js') }}@endif"></script>
