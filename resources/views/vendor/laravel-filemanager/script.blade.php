...
var image_url     = "@if(!App::environment('local')){{ secure_asset(Config::get('lfm.images_url')) }}@else{{ asset(Config::get('lfm.images_url')) }}@endif";
var file_url      = "@if(!App::environment('local')){{ secure_asset(Config::get('lfm.files_url')) }}@else{{ asset(Config::get('lfm.files_url')) }}@endif";
