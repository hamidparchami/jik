<div class="col-sm-4 col-md-3 col-lg-2">
  <div class="thumbnail text-center" data-id="{{ $dir_name['long'] }}">
    <a data-id="{{ $dir_name['long'] }}" class="folder-icon pointer folder-item">
      <img src="@if(!App::environment('local')){{ secure_asset('vendor/laravel-filemanager/img/folder.png') }}@else{{ asset('vendor/laravel-filemanager/img/folder.png') }}@endif" style='max-height:200px;'>
    </a>
  </div>
