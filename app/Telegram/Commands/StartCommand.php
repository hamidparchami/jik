...
//        $text    = 'Hi there!' . PHP_EOL . 'Type /help to see all commands!';
        $text    = "به‌ مجله جیک و پیک کامل ترین ربات  مشاوره سلامتی و زیبایی خوش آمدید (ویژه خانم ها و آقایان)"
                    ...
                    .PHP_EOL."پوست ویترین صورت شماست، اگر دغدغه پوست، سلامت و زیبایی خود را دارید, اگر داشتن پوست و صورتی زیبا خواسته ی همیشگی شماست، برای دانستن تمام اطلاعات زیبایی و پاسخ همه سوالات خود كافی است عضو مجله جیك و پیك شوید و مشاوره خود باشید."
